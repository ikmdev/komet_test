...
import dev.ikm.komet_test.kview.controls.skin.KLByteArrayControlSkin;
...
public class KLByteArrayControl extends Control {
    ...
    private static final ResourceBundle resources = ResourceBundle.getBundle("dev.ikm.komet_test.kview.controls.bytearray-control");
