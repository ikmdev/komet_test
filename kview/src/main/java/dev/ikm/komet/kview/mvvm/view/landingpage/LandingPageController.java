...
import dev.ikm.komet_test.kview.mvvm.model.JournalCounter;
import dev.ikm.komet_test.kview.events.CreateJournalEvent;
import dev.ikm.komet_test.kview.events.DeleteJournalEvent;
...
import static dev.ikm.komet_test.kview.klwindows.KlWindowPreferencesUtils.getJournalDirName;
import static dev.ikm.komet_test.kview.klwindows.KlWindowPreferencesUtils.getJournalPreferences;
import static dev.ikm.komet_test.kview.mvvm.model.Constants.JOURNAL_NAME_PREFIX;
import static dev.ikm.komet_test.kview.events.EventTopics.JOURNAL_TOPIC;
import static dev.ikm.komet_test.kview.events.CreateJournalEvent.CREATE_JOURNAL;
import static dev.ikm.komet_test.kview.events.JournalTileEvent.CREATE_JOURNAL_TILE;
import static dev.ikm.komet_test.framework.controls.TimeAgoCalculatorUtil.calculateTimeAgoWithPeriodAndDuration;
import static dev.ikm.komet_test.preferences.JournalWindowPreferences.*;
import static dev.ikm.komet_test.preferences.JournalWindowSettings.*;
