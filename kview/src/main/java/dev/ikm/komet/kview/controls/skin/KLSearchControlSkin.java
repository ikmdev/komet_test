...
import dev.ikm.komet_test.kview.controls.IconRegion;
 ...
 * {@link ListView<dev.ikm.komet_test.kview.controls.KLSearchControl.SearchResult>} with the
...
public class KLSearchControlSkin extends SkinBase<KLSearchControl> {
     ...
     * </p>
     * <p>Create the {@link ListView<dev.ikm.komet_test.kview.controls.KLSearchControl.SearchResult>} instance, and
    ...
    public KLSearchControlSkin(KLSearchControl control) {
        super(control);
        ResourceBundle resources = ResourceBundle.getBundle("dev.ikm.komet_test.kview.controls.search-control");
     ...
     * {@link dev.ikm.komet_test.kview.controls.KLSearchControl.SearchResult}.
     * </p>
    ...
    static class SearchResultBox extends Pane {
         ...
         * {@link dev.ikm.komet_test.kview.controls.KLSearchControl.SearchResult}
         * </p>
         * @param result a {@link dev.ikm.komet_test.kview.controls.KLSearchControl.SearchResult}
         */
         ...
         * {@link dev.ikm.komet_test.kview.controls.KLSearchControl.SearchResult} is set, this method performs
