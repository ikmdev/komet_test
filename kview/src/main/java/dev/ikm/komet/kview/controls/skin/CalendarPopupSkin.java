...
import dev.ikm.komet_test.kview.controls.CalendarPopup;
...
public class CalendarPopupSkin implements Skin<CalendarPopup> {
    ...
    private static final ResourceBundle resources = ResourceBundle.getBundle("dev.ikm.komet_test.kview.controls.instant-control");
