...
import static dev.ikm.komet_test.kview.events.pattern.PatternFieldsPanelEvent.ADD_FIELD;
import static dev.ikm.komet_test.kview.events.pattern.PatternFieldsPanelEvent.EDIT_FIELD;
import static dev.ikm.komet_test.kview.events.pattern.PropertyPanelEvent.CLOSE_PANEL;
import static dev.ikm.komet_test.kview.events.pattern.ShowPatternFormInBumpOutEvent.SHOW_CONTINUE_ADD_FIELDS;
import static dev.ikm.komet_test.kview.events.pattern.ShowPatternFormInBumpOutEvent.SHOW_CONTINUE_EDIT_FIELDS;
import static dev.ikm.komet_test.kview.mvvm.model.DataModelHelper.fetchFieldDefinitionDataTypes;
import static dev.ikm.komet_test.kview.mvvm.viewmodel.DescrNameViewModel.IS_INVALID;
import static dev.ikm.komet_test.kview.mvvm.viewmodel.FormViewModel.VIEW_PROPERTIES;
import static dev.ikm.komet_test.kview.mvvm.viewmodel.PatternFieldsViewModel.ADD_EDIT_LABEL;
import static dev.ikm.komet_test.kview.mvvm.viewmodel.PatternFieldsViewModel.COMMENTS;
import static dev.ikm.komet_test.kview.mvvm.viewmodel.PatternFieldsViewModel.DATA_TYPE;
import static dev.ikm.komet_test.kview.mvvm.viewmodel.PatternFieldsViewModel.DISPLAY_NAME;
import static dev.ikm.komet_test.kview.mvvm.viewmodel.PatternFieldsViewModel.FIELD_ORDER;
import static dev.ikm.komet_test.kview.mvvm.viewmodel.PatternFieldsViewModel.FIELD_ORDER_OPTIONS;
import static dev.ikm.komet_test.kview.mvvm.viewmodel.PatternFieldsViewModel.PREVIOUS_PATTERN_FIELD;
import static dev.ikm.komet_test.kview.mvvm.viewmodel.PatternFieldsViewModel.TOTAL_EXISTING_FIELDS;
import static dev.ikm.komet_test.kview.mvvm.viewmodel.PatternViewModel.MEANING_ENTITY;
import static dev.ikm.komet_test.kview.mvvm.viewmodel.PatternViewModel.PATTERN_TOPIC;
import static dev.ikm.komet_test.kview.mvvm.viewmodel.PatternViewModel.PURPOSE_ENTITY;
...
import dev.ikm.komet_test.kview.events.pattern.PatternFieldsPanelEvent;
...
import dev.ikm.komet_test.kview.mvvm.viewmodel.PatternFieldsViewModel;
