...
import static dev.ikm.komet_test.kview.controls.KLConceptNavigatorControl.MAX_LEVEL;
...
public class ConceptNavigatorUtils {
     ...
     * @param navigator the {@link Navigator} that holds the dataset
     * @return a list of {@link dev.ikm.komet_test.kview.controls.InvertedTree.ConceptItem}
     */
    ...
    /**
     * <p>Builds the {@link InvertedTree} for a given {@link dev.ikm.komet_test.kview.controls.InvertedTree.ConceptItem},
     ...
     * </p>
     * @param conceptItem a given {@link dev.ikm.komet_test.kview.controls.InvertedTree.ConceptItem}
     * @param navigator the {@link Navigator} that holds the dataset
