...
import dev.ikm.komet_test.kview.controls.KLComponentSetControl;
...
//          e.g., This control should allow a user to drag a concept from classic concept navigator.
    ...
    private static String getString(String key) {
        return ResourceBundle.getBundle("dev.ikm.komet_test.kview.controls.component-control").getString(key);
    }
}
