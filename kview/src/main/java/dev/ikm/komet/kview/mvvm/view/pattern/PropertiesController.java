...
import dev.ikm.komet_test.kview.events.pattern.PatternDescriptionEvent;
...
import dev.ikm.komet_test.kview.mvvm.model.PatternDefinition;
import dev.ikm.komet_test.kview.mvvm.model.PatternField;
import dev.ikm.komet_test.kview.mvvm.view.descriptionname.DescriptionNameController;
import dev.ikm.komet_test.kview.mvvm.viewmodel.DescrNameViewModel;
import dev.ikm.komet_test.kview.mvvm.viewmodel.PatternDefinitionViewModel;
import dev.ikm.komet_test.kview.mvvm.viewmodel.PatternPropertiesViewModel;
import dev.ikm.komet_test.kview.mvvm.viewmodel.PatternViewModel;
...
import static dev.ikm.komet_test.kview.events.pattern.PropertyPanelEvent.DEFINITION_CONFIRMATION;
import static dev.ikm.komet_test.kview.events.pattern.PropertyPanelEvent.OPEN_PANEL;
import static dev.ikm.komet_test.kview.events.pattern.ShowPatternFormInBumpOutEvent.*;
import static dev.ikm.komet_test.kview.mvvm.viewmodel.DescrNameViewModel.CREATE;
import static dev.ikm.komet_test.kview.mvvm.viewmodel.DescrNameViewModel.MODE;
import static dev.ikm.komet_test.kview.mvvm.viewmodel.DescrNameViewModel.VIEW_PROPERTIES;
import static dev.ikm.komet_test.kview.mvvm.viewmodel.DescrNameViewModel.*;
import static dev.ikm.komet_test.kview.mvvm.viewmodel.PatternFieldsViewModel.*;
import static dev.ikm.komet_test.kview.mvvm.viewmodel.PatternViewModel.*;
import static dev.ikm.komet_test.kview.state.PatternDetailsState.NEW_PATTERN_INITIAL;
