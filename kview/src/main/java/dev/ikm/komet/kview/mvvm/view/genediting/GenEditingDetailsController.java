 ...
 */
package dev.ikm.komet_test.kview.mvvm.view.genediting;


import static dev.ikm.komet_test.framework.observable.ObservableEntity.updateVersions;
import static dev.ikm.komet_test.kview.events.genediting.PropertyPanelEvent.CLOSE_PANEL;
import static dev.ikm.komet_test.kview.events.genediting.PropertyPanelEvent.OPEN_PANEL;
import static dev.ikm.komet_test.kview.events.genediting.PropertyPanelEvent.SHOW_ADD_REFERENCE_SEMANTIC_FIELD;
import static dev.ikm.komet_test.kview.events.genediting.PropertyPanelEvent.SHOW_EDIT_SEMANTIC_FIELDS;
import static dev.ikm.komet_test.kview.events.genediting.PropertyPanelEvent.SHOW_EDIT_SINGLE_SEMANTIC_FIELD;
...
import static dev.ikm.komet_test.kview.klfields.KlFieldHelper.retrieveCommittedLatestVersion;
import static dev.ikm.komet_test.kview.mvvm.viewmodel.DescrNameViewModel.MODULES_PROPERTY;
...
import static dev.ikm.komet_test.kview.mvvm.viewmodel.FormViewModel.EDIT;
...
import static dev.ikm.komet_test.kview.mvvm.viewmodel.GenEditingViewModel.PATTERN;
import static dev.ikm.komet_test.kview.mvvm.viewmodel.GenEditingViewModel.REF_COMPONENT;
import static dev.ikm.komet_test.kview.mvvm.viewmodel.GenEditingViewModel.SEMANTIC;
import static dev.ikm.komet_test.kview.mvvm.viewmodel.GenEditingViewModel.STAMP_VIEW_MODEL;
import static dev.ikm.komet_test.kview.mvvm.viewmodel.GenEditingViewModel.WINDOW_TOPIC;
...
import dev.ikm.komet_test.kview.controls.KLReadOnlyBaseControl;
import dev.ikm.komet_test.kview.controls.KLReadOnlyComponentControl;
import dev.ikm.komet_test.kview.events.genediting.GenEditingEvent;
import dev.ikm.komet_test.kview.events.genediting.PropertyPanelEvent;
import dev.ikm.komet_test.kview.klfields.KlFieldHelper;
import dev.ikm.komet_test.kview.mvvm.view.stamp.StampEditController;
import dev.ikm.komet_test.kview.mvvm.viewmodel.GenEditingViewModel;
...
public class GenEditingDetailsController {
    ...
    private void setupProperties() {
        ...
        propertiesEventSubscriber = (evt) -> {
            if (evt.getEventType() == dev.ikm.komet_test.kview.events.genediting.PropertyPanelEvent.CLOSE_PANEL) {
