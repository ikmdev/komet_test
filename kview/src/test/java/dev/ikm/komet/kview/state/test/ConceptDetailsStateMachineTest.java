 ...
 */
package dev.ikm.komet_test.kview.state.test;

import dev.ikm.komet_test.kview.state.pattern.ConceptDetailsPattern;
...
import static dev.ikm.komet_test.kview.state.ConceptDetailsState.BF_NO_FQN;
import static dev.ikm.komet_test.kview.state.ConceptDetailsState.EDITING_OTN_NO_FQN;
