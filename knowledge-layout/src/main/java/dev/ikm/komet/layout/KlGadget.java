...
import dev.ikm.komet_test.layout.window.KlFxWindow;
import dev.ikm.komet_test.layout.window.KlJournalWindow;
import dev.ikm.komet_test.layout.window.KlFrame;
...
import static dev.ikm.komet_test.layout.KlObject.PreferenceKeys.FACTORY_CLASS;
import static dev.ikm.komet_test.layout.KlObject.PropertyKeys.*;
